...
class HalfCheetahEnv(MujocoEnv, utils.EzPickle):
    ...
    * v0: Initial versions release (1.0.0)
    ...
    def step(self, action):
        ...
        # print("cost----------:", np.square(observation[0] - height))
        ## changed end
        ...
        info = {
            ...
            "reward1": -np.abs(x_velocity - self._goal_vel),  # todo: reward objective one
            "reward2": -ctrl_cost,  # todo: reward objective two
            "cost": -np.abs(observation[0] - height),  # todo: safety
        }
