...
class HopperEnv_Four(MujocoEnv, utils.EzPickle):
    """
    ### Description
    ...
    * v0: Initial versions release (1.0.0)
    ...
    def is_healthy(self):
        ...
        # return health_value
        return float(health_1), float(health_2), float(health_3)
    ...
    def step(self, action):
        ...
        healthy_reward_1, healthy_reward_2, healthy_reward_3 = self.healthy_reward
        ...
        info = {
            ...
            "reward2": healthy_reward_1 + healthy_reward_3,
            "reward3": healthy_reward_2,
            "reward4": healthy_reward_3,
            "cost": -costs,
        }
